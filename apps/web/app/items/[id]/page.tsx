  ...
  return (
    <div className="max-w-[1240px] space-y-8 text-[#e6e0d2]">
      <div className="space-y-3">
        <section className="max-w-[650px] rounded-[12px] border border-white/10 bg-[linear-gradient(180deg,rgba(23,29,38,0.96),rgba(14,19,27,0.94))] px-4 py-3 shadow-[0_18px_40px_rgba(0,0,0,0.3)] backdrop-blur-sm sm:px-4 sm:py-3">
          <div className="space-y-3">
